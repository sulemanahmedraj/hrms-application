      ...
      >
        <View className="flex-1 px-6 py-12">
          ...
          <View className="items-center mb-12">
            ...
            <Text className="text-3xl  text-foreground text-center mb-2">Forgot Password?</Text>
              ...
              <Controller
                ...
                render={({ field: { onChange, value } }) => (
                  <View className="space-y-4">
                    <Label htmlFor='email' className="text-foreground mb-2 ml-1">Email Address</Label>
                    <Input
